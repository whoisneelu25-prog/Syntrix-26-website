...
export const eventConfig: EventConfig = {
  ...
  day: "FRIDAY",
  time: "9:00 AM",
  venue: "REPORT TO SEMINAR HALL • EVENTS IN AI&DS BLOCK",
  ...
  events: [
    {
      ...
      shortDescription: "Deliver an original technical presentation on topics mentioned in the Google Form. PPT template is of your choice.",
      fullDescription: "PAPER 404 is the premier technical symposium track of SYNTRIX'26 Phase 1. Participants choose their domain from the topics listed in the official Google Form and are completely free to use any PPT template of their choice. Deliver an impactful presentation demonstrating technical depth, innovation, and relevance.",
      iconName: "FileCode2",
      badge: "PHASE 1: RESEARCH",
      round: "Single Round",
      teamSize: "2–3 members",
      duration: "4 mins per team",
      topic: "TOPICS ARE MENTIONED IN THE GOOGLE FORM (PPT TEMPLATE IS OF YOUR CHOICE)",
      venue: "AI&DS Block (Report to Seminar Hall)",
      rules: [
        "Presentation topics are mentioned in the official Google Form (select during registration).",
        "PPT template is of the participant's choice (any slide template of your choice can be used).",
        "Presentation must be original and plagiarism-free.",
        "All team members must participate in the presentation.",
        "Evaluation: Technical Knowledge + Innovation + Relevance + Presentation Delivery.",
        "Exceeding the time limit (4 mins) may result in score deduction."
      ],
      registrationLink: OFFICIAL_REGISTRATION_URL
    },
    {
      ...
      subtitle: "Startup Pitch Challenge",
      tagline: "YOUR TOPIC. YOUR VISION. YOUR PITCH.",
      shortDescription: "Pitch your own startup concept! Bring your own chosen topic (no on-spot topics) and pitch it like a unicorn.",
      fullDescription: "CRAZY PITCH is an adrenaline-charged Phase 1 ideation challenge. Bring your own startup topic and pitch it like it is the next billion-dollar company! There are NO on-spot topics provided — participants prepare and pitch their own unique, crazy, and visionary startup ideas.",
      concept: "Pitch your own startup idea! Bring your own chosen topic, build your value proposition, and pitch your startup idea. No on-spot topics will be given.",
      animatedTagline: "BRING YOUR OWN TOPIC. MAKE IT INVESTABLE.",
      topic: "BRING YOUR OWN TOPIC (NO ON-SPOT TOPICS)",
      examplePrompts: [
        "Smart Eco-Tech & Circular Waste Management",
        "AI-Powered Autonomous Healthcare Diagnostics",
        "Next-Gen Electric Vehicle Fleet Optimization",
        "Decentralized Agri-Tech Supply Chain Solution",
        "Adaptive EdTech Micro-Learning Ecosystem"
      ],
      iconName: "Rocket",
      ...
      venue: "AI&DS Block (Report to Seminar Hall)",
      rules: [
        "Participants must bring and pitch their own startup topic (No on-spot topics will be given).",
        "Pitch your own startup idea — explain the problem, solution, target market, and business model.",
        "Pitch duration: 5 minutes per team followed by jury Q&A.",
        "Be innovative, creative, bold, or visionary with your startup proposition.",
        "Offensive or inappropriate content is strictly prohibited.",
        "Evaluation: Problem-Solution Fit + Innovation + Business Viability + Pitch Delivery.",
